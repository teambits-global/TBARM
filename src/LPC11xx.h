...
#define IOCON_R_PIO0_11					LPC_IOCON->R_PIO0_11	
#define IOCON_R_PIO1_0					LPC_IOCON->R_PIO1_0	
#define IOCON_R_PIO1_1					LPC_IOCON->R_PIO1_1	
#define IOCON_R_PIO1_2					LPC_IOCON->R_PIO1_2	
...
#define IOCON_SCK_LOC					LPC_IOCON->SCK_LOC


#define SYSCON_PDRUNCFG				LPC_SYSCON->PDRUNCFG
#define SYSCON_PRESETCTRL			LPC_SYSCON->PRESETCTRL
#define SYSCON_SYSAHBCLKCTRL		LPC_SYSCON->SYSAHBCLKCTRL
#define SYSCON_SPICLKDIV			LPC_SYSCON->SSP0CLKDIV	
#define SYSCON_UARTCLKDIV     		LPC_SYSCON->UARTCLKDIV

#define SYSCON_WDTOSCCTRL     		LPC_SYSCON->WDTOSCCTRL
#define SYSCON_WDTCLKSEL			LPC_SYSCON->WDTCLKSEL
#define SYSCON_WDTCLKUEN			LPC_SYSCON->WDTCLKUEN
#define SYSCON_WDTCLKDIV			LPC_SYSCON->WDTCLKDIV

#define GPIO0_DIR					LPC_GPIO0->DIR
#define GPIO0_DATA					LPC_GPIO0->DATA
#define GPIO0_IS					LPC_GPIO0->IS
#define GPIO0_IBE					LPC_GPIO0->IBE
#define GPIO0_IEV					LPC_GPIO0->IEV
#define GPIO0_IE					LPC_GPIO0->IE
#define GPIO0_IC					LPC_GPIO0->IC

#define GPIO1_DIR					LPC_GPIO1->DIR
#define GPIO1_DATA				LPC_GPIO1->DATA
#define GPIO1_IS					LPC_GPIO1->IS
#define GPIO1_IBE					LPC_GPIO1->IBE
#define GPIO1_IEV					LPC_GPIO1->IEV
#define GPIO1_IE					LPC_GPIO1->IE
#define GPIO1_IC					LPC_GPIO1->IC

#define GPIO2_DIR					LPC_GPIO2->DIR
#define GPIO2_DATA					LPC_GPIO2->DATA
#define GPIO2_IS					LPC_GPIO2->IS
#define GPIO2_IBE					LPC_GPIO2->IBE
#define GPIO2_IEV					LPC_GPIO2->IEV
#define GPIO2_IE					LPC_GPIO2->IE
#define GPIO2_IC					LPC_GPIO2->IC

#define GPIO3_DIR					LPC_GPIO3->DIR
#define GPIO3_DATA					LPC_GPIO3->DATA
#define GPIO3_IS					LPC_GPIO3->IS
#define GPIO3_IBE					LPC_GPIO3->IBE
#define GPIO3_IEV					LPC_GPIO3->IEV
#define GPIO3_IE					LPC_GPIO3->IE
#define GPIO3_IC					LPC_GPIO3->IC
...
#define WDT_MOD								LPC_WDT->MOD
#define WDT_TC 								LPC_WDT->TC
#define WDT_FEED							LPC_WDT->FEED
#define WDT_TV 								LPC_WDT->TV
...
#define SPI_CR0								LPC_SSP0->CR0
#define SPI_CR1								LPC_SSP0->CR1
#define SPI_DR								LPC_SSP0->DR
#define SPI_SR								LPC_SSP0->SR
#define SPI_CPSR							LPC_SSP0->CPSR

#define ADC_CR								LPC_ADC->CR
#define ADC_DR0								LPC_ADC->DR[0]
#define ADC_DR1								LPC_ADC->DR[1]
#define ADC_DR2								LPC_ADC->DR[2]
#define ADC_DR3								LPC_ADC->DR[3]
#define ADC_DR4								LPC_ADC->DR[4]
#define ADC_DR5								LPC_ADC->DR[5]
#define ADC_DR6								LPC_ADC->DR[6]
#define ADC_DR7								LPC_ADC->DR[7]

#define UART_RBR				LPC_UART->RBR
#define UART_THR              	LPC_UART->THR
#define UART_FDR              	LPC_UART->FDR
#define UART_DLL              	LPC_UART->DLL
#define UART_DLM              	LPC_UART->DLM
#define UART_FCR              	LPC_UART->FCR
#define UART_LCR              	LPC_UART->LCR
#define UART_LSR              	LPC_UART->LSR

#define GPT0_TCR          		LPC_TMR32B0->TCR    
#define GPT0_CTCR             	LPC_TMR32B0->CTCR   
#define GPT0_TC               	LPC_TMR32B0->TC     
#define GPT0_PR               	LPC_TMR32B0->PR     
#define GPT0_MCR              	LPC_TMR32B0->MCR    
#define GPT0_MR0              	LPC_TMR32B0->MR0    
#define GPT0_MR1              	LPC_TMR32B0->MR1    
#define GPT0_MR2              	LPC_TMR32B0->MR2    
#define GPT0_MR3              	LPC_TMR32B0->MR3    
#define GPT0_EMR             		LPC_TMR32B0->EMR   
#define GPT0_PWMC             	LPC_TMR32B0->PWMC   

#define GPT1_TCR          		LPC_TMR32B1->TCR    
#define GPT1_CTCR             	LPC_TMR32B1->CTCR   
#define GPT1_TC               	LPC_TMR32B1->TC     
#define GPT1_PR               	LPC_TMR32B1->PR     
#define GPT1_MCR              	LPC_TMR32B1->MCR    
#define GPT1_MR0              	LPC_TMR32B1->MR0    
#define GPT1_MR1              	LPC_TMR32B1->MR1    
#define GPT1_MR2              	LPC_TMR32B1->MR2    
#define GPT1_MR3              	LPC_TMR32B1->MR3
#define GPT1_EMR             		LPC_TMR32B1->EMR   
#define GPT1_PWMC             	LPC_TMR32B1->PWMC   
